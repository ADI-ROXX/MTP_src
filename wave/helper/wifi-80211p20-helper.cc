 ...
 */
#include "wifi-80211p20-helper.h"
...
Wifi80211p20Helper::Wifi80211p20Helper()
{
}
...
Wifi80211p20Helper
Wifi80211p20Helper::Default()
{
    Wifi80211p20Helper helper;
    helper.SetStandard(WIFI_STANDARD_80211p20);
...
void
Wifi80211p20Helper::SetStandard(WifiStandard standard)
{
    if (standard == WIFI_STANDARD_80211p20)
    {
...
void
Wifi80211p20Helper::EnableLogComponents()
{
...
NetDeviceContainer
Wifi80211p20Helper::Install(const WifiPhyHelper& phyHelper,
                          ...
                          uint32_t& cwmax_) 
{
    ...
    return WifiHelper::Install(phyHelper, macHelper,c, cwmax_);
}
