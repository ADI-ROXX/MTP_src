 ...
 */
#ifndef WIFI_802_11P20_HELPER_H
#define WIFI_802_11P20_HELPER_H
 ...
 */
class Wifi80211p20Helper : public WifiHelper
{
  public:
    Wifi80211p20Helper();
    ~Wifi80211p20Helper() override;

    /**
     * \returns a new Wifi80211p20Helper in a default state
     *
     ...
     */
    static Wifi80211p20Helper Default();
    ...
    NetDeviceContainer Install(const WifiPhyHelper& phy,
                               const WifiMacHelper& macHelper,
                               NodeContainer c, uint32_t& cwmax_)  ;
